...
This is a [JSON API](http://jsonapi.org) adapter for [Ember Data](http://github.com/emberjs/data) 1.13, that extends the built-in REST adapter. Please note that
Please note that Ember Data and JSON API are both works in progress, use with caution.
